...
namespace Antmicro.Renode.Peripherals.CPU
{
    ...
    {
        public ARMv8A(IMachine machine, string cpuType, ARM_GenericInterruptController genericInterruptController, ulong cpuId = 0, Endianess endianness = Endianess.LittleEndian)
